...
namespace EFCoreMovies.Migrations
{
    ...
    [Migration("20220531163357_Posts")]
    partial class Posts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Body = "When Arwen and Aragorn met first time Aragorn was 20 and Arwen was 2710 years old. Don't you think they felt generational gap between each others? How could they handle it?",
                            SenderId = 1,
                        ...
                        {
                            Id = 6,
                            Body = "They are fictious characters of Tolkien. I don't think he used this level of complex details in his fictions.",
                            ParentPostId = 2,
                            SenderId = 3,
                            Subject = "Re: Arwen and Aragorn"
                        },
                        ...
                        {
                            Id = 4,
                            Body = "Hello, I'm looking for discount coupons for Top Gun 2 movie. Anyone can help me?",
                            SenderId = 2,
                            Subject = "Coupons"
                        },
                        new
            ...
            modelBuilder.Entity("EFCoreMovies.Entities.Post", b =>
                {
                    b.HasOne("EFCoreMovies.Entities.Post", "ParentPost")
                        .WithMany("SubPosts")
